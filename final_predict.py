...
page = st.sidebar.selectbox("Select a page", ["Main Page", "Financial Data Extraction Page"])

# Initialize the exchange (e.g., Binance)
exchange = ccxt.binance()

# Financial Data Extraction Page
if page == "Financial Data Extraction Page":
    # Your code for the financial data extraction page
...
if page == "Main Page":
    ...
    if not crypto_data.empty:
        ...
        for symbol in selected_crypto_symbols:  # Use selected_crypto_symbols for crypto prediction
